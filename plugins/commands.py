...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('• ᴍᴀsᴛᴇʀ •', url="https://t.me/mysterious_mikey"),
                    InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ •', url='https://t.me/RSK_SUPPORT1')
                ],[
                    InlineKeyboardButton('• ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ •', url="https://t.me/cinee_bros_updates")
                  ]]
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "ɢᴏᴏᴅ ɴɪɢʜᴛ 👋"
        m=await message.reply_text("<b><i>ʜᴇʟʟᴏ ʙᴀʙʏ, ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ\nᴡᴀɪᴛ ᴀ ᴍᴏᴍᴇɴᴛ ʙᴀʙʏ...</i></b>")
        await asyncio.sleep(0.2)
        await m.edit_text("<b><i>sᴛᴀʀᴛɪɴɢ ʙᴀʙʏ...</i></b>")
        await asyncio.sleep(0.2)
        await m.delete()        
        m=await message.reply_sticker("CAACAgUAAxkBAAEDMitmHlpsvzTZlOX4ZCPI7uP0P7B1TAACIgwAAqv1OVZjQwGUqMu7nB4E") 
        await asyncio.sleep(0.2)
        await m.delete()
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs •', url=f'https://t.me/cinee_bros_updates') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/RSK_How_to_Download/15</code></b>")
